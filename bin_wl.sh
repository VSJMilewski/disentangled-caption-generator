...
python3 $HOME/multimodal-descriptions/main.py --beam_size 1 --model BINARY --dataset flickr8k --device cuda --num_workers 16 --batch_size 256 --min_epochs 0 --max_epochs 100 --patience 10 --vocab_threshold 5 --max_time 169200 --max_grad 5 --optimizer Adam --binary_train_method WEIGHTED_LOSS
