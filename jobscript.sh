...
python3 $HOME/multimodal-descriptions/main.py --beam_size 1 --dataset flickr8k --device cuda --num_workers 16 --batch_size 512 --min_epochs 0 --max_epochs 500 --patience 10 --vocab_threshold 5 --max_time 5400 --max_grad 5 --optimizer Adagrad --unique adagrad_gradclip5_2lstm &
